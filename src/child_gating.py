...
class Application(object):
    ...
    def _start(self):
        ...
        print("✔ spawn com.wsg.v3")

        # pid = self._device.spawn(["com.wsg.v3"])

        device = frida.get_device_manager().add_remote_device("192.168.124.25:31928")
        pid = device.spawn("com.wsg.v3")
